...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  ...
  { TEXT_CreateIndirect, "Text1", ID_TEXT_0, 0, 0, 480, 50, 0, 0x64, 0 },
  ...
  { TEXT_CreateIndirect, "Text2", ID_TEXT_1, 40, 100, 400, 40, 0, 0x64, 0 },
  ...
  { CHECKBOX_CreateIndirect, "Checkbox1", ID_CHECKBOX_0, 160, 330, 127, 20, 0, 0x0, 0 },
  { CHECKBOX_CreateIndirect, "Checkbox2", ID_CHECKBOX_1, 160, 360, 131, 20, 0, 0x0, 0 },
  { BUTTON_CreateIndirect, "Button4", ID_BUTTON_3, 40, 410, 150, 60, 0, 0x0, 0 },
  { BUTTON_CreateIndirect, "Button5", ID_BUTTON_4, 280, 410, 150, 60, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "Text4", ID_TEXT_3, 40, 340, 111, 32, 0, 0x64, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    TEXT_SetTextAlign(hItem, GUI_TA_LEFT | GUI_TA_VCENTER);
    TEXT_SetFont(hItem, GUI_FONT_20_ASCII);
    TEXT_SetText(hItem, "Drill Check");
    TEXT_SetTextColor(hItem, GUI_MAKE_COLOR(0x0000FFFF));
